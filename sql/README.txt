...
2. format.py          -python script that formats most of the legacy data so that it may be inserted in the LOST database 
		      ...
		      -intake/export dates are not included in this version of the data migration. Date format was inconsistent                        througout the legacy data which made it difficult to streamline the process. A later version will incorpo                       rate this data
